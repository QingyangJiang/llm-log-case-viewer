...
export function RouteRegalia({ path, stage, front = false }: { path: IllustratedRoute; stage: number; front?: boolean }) {
  ...
  if (!front) return <g data-regalia-tier={tier} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    {path === "nba" && mature ? <g stroke="#c5a56b">
      <path d={exalted ? "M23 22h114v59l-23-10-34 11-34-11-23 10Z" : "M31 32h98v42l-23-7-26 11-26-11-23 7Z"} fill={final ? "#efcf85" : "#ddd5eb"} />
      <path d="M32 31h96M80 24v14" stroke="#fff8d5" strokeWidth="3" />
      <text x="80" y="36" fontFamily="sans-serif" fontSize="9" fontWeight="800" textAnchor="middle" fill="#77623d" stroke="none">{final ? "LEGEND" : exalted ? "CHAMPIONS" : "ALL STAR"}</text>
      {final ? <path d="m19 31-4 85 15 14m111-99 4 85-15 14" stroke="#ba9560" strokeWidth="4" fill="none" /> : null}
    </g> : null}
  ...
  return <g data-regalia-front={tier} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    {path === "nba" ? <g stroke="#766083"><path d="m56 94-14 7-5 19 12 3 14-23m41-6 14 7 5 19-12 3-14-23" fill={tier >= 2 ? "#eee6d0" : "#9073b9"} /><path d="M61 98q19 12 38 0v24H61Z" fill={mature ? "#f3da93" : tier >= 2 ? "#fff3d3" : "#8165b7"} /><path d="M65 103v15m30-15v15" stroke="#b4915f" /><text x="80" y="118" fontSize="14" fontFamily="sans-serif" fontWeight="800" fill="#76557e" textAnchor="middle" stroke="none">01</text>{final ? <path d="M60 123h40v6H85l-5-8-5 8H60Z" fill="#dfbd77" /> : null}</g> : null}
