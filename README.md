...
新增八条路线使用完整矢量角色：紫晶机甲、御剑灵狐、深渊骑士、奶橘球星、鎏金神兽、疾风特工、符文幼龙和隐藏星灵。工作室、标注搭子、家园、切磋及衣柜共用同一套角色画面；3 阶增加柔光，6 阶增加光环，并适配已有衣服与装备。毛色选择会映射到角色的核心、头带或服饰点缀。进化页新增外观图鉴，隐藏路线在获得前只显示问号。
