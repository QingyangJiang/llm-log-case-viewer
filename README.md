...
- 宠物装备与技能：摸摸、提交标注、发现 Badcase 均可能掉落装备；图鉴包含 300 件、5 个穿戴部位和 5 档稀有度。3 件同名装备可概率合成至 Lv.10，并生成可暴击、可重复叠加的随机效果词条；还可消耗同名材料洗练词条。每件装备都有固定效果，同主题 2/3/5 件可激活套装共鸣。进化可觉醒 8 种技能，最多启用 3 个并实际影响掉率或进化概率
